    ...
    <>
      ...
      <div className="mt-auto p-4 border-t border-white/30">
        <button 
          ...
          className="w-full bg-primary-container text-white dark:text-on-primary-container font-label-md text-label-md py-3 rounded-lg shadow-md hover:bg-primary transition-colors flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-all"
        >
